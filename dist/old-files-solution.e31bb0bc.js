...
},{}],"js/panel.class.js":[function(require,module,exports) {
'use strict';
...
class Panel {
  ...
  creatPanel(data, controller) {
    // console.log(data);
    let markup = this.createMarkup(data, controller); // console.log(markup);
  ...
  createMarkup(values, controller) {
    // console.log(values);
    let tempHTML = '';
    let params = this.version.split('--'); // console.log(params);
    ...
    switch (params[0]) {
      ...
      case 'archive':
        let data = this.buildStructure(values); // console.log(data);
    ...
    data.forEach(item => {
      if (item.section != undefined) {
        if (!Object.keys(structData).includes(item.section)) {
          ...
          structData[item.section] = {
            sections: {},
            docs: []
          };
        } else {// console.log('section already exist');
        }
      }
      ...
      if (item.sub_section != undefined) {
        ...
        if (!Object.keys(structData[item.section].sections).includes(item.sub_section)) {
          ...
          structData[item.section].sections[item.sub_section] = {
            sections: {},
            docs: []
          };
...
},{"whatwg-fetch":"node_modules/whatwg-fetch/fetch.js"}],"js/controller.class.js":[function(require,module,exports) {
'use strict';
...
var _panelClass = _interopRequireDefault(require("./panel.class.js"));
...
class Controller {
  constructor(version, source) {
    this.source = source;
    this.panel = new _panelClass.default(version);
    this.initialLoad(this);
  }

  initialLoad(controller) {
    fetch(controller.source).then(resp => resp.json()) // Transform the data into json
    .then(function (data) {
...
},{"./panel.class.js":"js/panel.class.js","isomorphic-fetch":"node_modules/isomorphic-fetch/fetch-npm-browserify.js"}],"index.js":[function(require,module,exports) {
'use strict';
...
(function () {
  try {
    ...
    let controller = new _controller.default(format, source);
  } catch (e) {
    console.log('no archive to display');
  }
})(window);
},{"./js/controller.class":"js/controller.class.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/old-files-solution.e31bb0bc.js.map