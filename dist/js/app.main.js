...
var Panel = function () {
  ...
  _createClass(Panel, [{
    ...
    value: function creatPanel(data, controller) {
      var markup = controller.panel.createMarkup(data.data, controller);
