...
var Panel = function () {
  ...
  _createClass(Panel, [{
    ...
    value: function creatPanel(data, controller) {
      // console.log(data);
      var markup = this.createMarkup(data, controller);
      // console.log(markup);
    ...
    key: 'buildHeaders',
    value: function buildHeaders(value, lvl) {
      var _this = this;
      ...
      Object.entries(value).forEach(function (_ref) {
        ...
        tempHTML += '\n      <div class="card">\n        <div class="card-header" id="h-' + tempLvl + '-' + _this.indexes[tempLvl] + '">\n          <h5 class="mb-0">\n            <button class="btn btn-link" data-toggle="collapse" data-target="#c-' + tempLvl + '-' + _this.indexes[tempLvl] + '" aria-expanded="true" aria-controls="c-' + tempLvl + '-' + _this.indexes[tempLvl] + '">\n              ' + key + '\n            </button>\n          </h5>\n        </div>\n\n        ' + _this.buildChildren(data, tempLvl) + '\n      </div>\n      ';
        _this.indexes[tempLvl]++;
      });
          ...
          switch (params[1]) {
            case 'v01':
              ...
              Object.entries(data).forEach(function (_ref3) {
                ...
                tempHTML += '\n              <div class="card">\n                <div class="card-header" id="h-' + tempIndexLvl + '-' + _this2.indexes[tempIndexLvl] + '">\n                  <h5 class="mb-0">\n                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#c-' + tempIndexLvl + '-' + _this2.indexes[tempIndexLvl] + '" aria-expanded="true" aria-controls="c-' + tempIndexLvl + '-' + _this2.indexes[tempIndexLvl] + '">\n                      ' + key + '\n                    </button>\n                  </h5>\n                </div>\n                ' + _this2.buildChildren(value, tempIndexLvl) + '\n              </div>\n              ';
                _this2.indexes[tempIndexLvl]++;
              });
              break;
            default:
