...
var _panelClass = require('./panel.class.js');
...
var Controller = function () {
  function Controller(version, source) {
    _classCallCheck(this, Controller);

    this.source = source;
    this.panel = new _panelClass2.default(version);
    this.initialLoad(this);
  }

  _createClass(Controller, [{
    key: 'initialLoad',
    value: function initialLoad(controller) {
      fetch(controller.source).then(function (resp) {
        return resp.json();
...
},{"./panel.class.js":3,"isomorphic-fetch":4}],2:[function(require,module,exports){
'use strict';
...
(function () {
  try {
    var format = document.querySelector('input[name="archive-format"]').value;
    var source = document.querySelector('input[name="archive-source"]').value;
    var controller = new _controllerClass2.default(format, source);
  } catch (e) {
...
var Panel = function () {
  ...
  _createClass(Panel, [{
    key: 'creatPanel',
    value: function creatPanel(data, controller) {
      console.log(data);
      var markup = controller.panel.createMarkup(data, controller);
      console.log(markup);
    ...
    key: 'getFileLink',
    value: function getFileLink(value, baseURL) {
      var tempHTML = null;
    ...
    key: 'getIndexID',
    value: function getIndexID(lvl, controller) {
      var tempID = '';
      for (var index = 0; index < lvl + 1; index++) {
    ...
    key: 'buildChildren',
    value: function buildChildren(mainValue, basePath, lvl, controller) {
      var tempIndexLvl = lvl;
      var tempHTML = '';
      if (Array.isArray(mainValue)) {
        tempHTML = '\n      <div id="c-' + controller.panel.getIndexID(lvl, controller) + '" class="collapse" aria-labelledby="h-' + controller.panel.getIndexID(lvl, controller) + '">\n        <div class="card-body">\n          <ul>\n            ' + mainValue.map(function (doc) {
          return '\n              <li>' + controller.panel.getFileLink({ doc: doc }, basePath) + '</li>\n            ';
        }).join('') + '\n          </ul>\n        </div>\n      </div>\n      ';
      } else {
        ...
        Object.entries(mainValue).forEach(function (_ref) {
    ...
    value: function createMarkup(values, controller) {
      ...
      switch (params[0]) {
        case 'table':
          ...
          break;
        case 'archive':
          var data = this.buildStructure(values);
          switch (params[1]) {
            case 'v01':
              var tempIndexLvl = 0;
              controller.panel.indexes.push(0);
              Object.entries(values.reports).forEach(function (_ref3) {
    ...
    key: 'buildStructure',
    value: function buildStructure(data) {
      console.log(data);
      var structData = [];
...
},{"moment":5}],4:[function(require,module,exports){
